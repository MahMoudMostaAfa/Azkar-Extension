...
export const PRAYER_NAMES = {
  ...
  dhuhr: { nameAr: "الظهر", nameEn: "Dhuhr", icon: "☀️" },
...
export const TRANSLATIONS = {
  ...
  fr: {
    ...
    streak: "Série",
    days: "jours",
    customAzkar: "Azkar Personnalisés",
    addCustom: "Ajouter un Dhikr",
  ...
  ur: {
    ...
    streak: "تسلسل",
    days: "دن",
    customAzkar: "مخصوص اذکار",
    addCustom: "ذکر شامل کریں",
    prayerReminder: "نماز کی یاددہانی",
